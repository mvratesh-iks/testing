...
CONFIG = {
    ...
    # === Watchlist (only profitable stocks from v3 backtest) ===
    # Removed: ICICIBANK(-615), TMCV(-290), TCS(-264), SUNPHARMA(-70), SBIN(-66)
    # Kept: All 9 stocks that showed positive gross P&L in backtest
    "WATCHLIST": [
        "TMPV",       # +₹719 | 65% win rate ✅ Best performer
        "KOTAKBANK",  # +₹467 | 67% win rate ✅
        "MARUTI",     # +₹441 | 54% win rate ✅
        "BAJAJ-AUTO", # +₹375 | 64% win rate ✅
        "WIPRO",      # +₹377 | 63% win rate ✅ Fewest trades, best ratio
        "HDFCBANK",   # +₹269 | 62% win rate ✅
        "RELIANCE",   # +₹186 | 64% win rate ✅
        "INFY",       # +₹74  | 55% win rate ✅ Borderline but positive
        "DRREDDY",    # +₹75  | 47% win rate ✅ Borderline but positive
    ],
